...
df_rv = tibble(
               area_min_triangle = area_min_triangle, 
               area_max_triangle = area_max_triangle, 
               area_end_triangle = area_end_triangle, 
               area_uc_full = area_uc_full,
               area_uc_upper = area_uc_upper
               )
